...
OUT_URDF="${MESH_DIR}/aftf_taxel1_mujoco.urdf"

usage() {
  cat <<'EOF'
Usage:
  ./generate_aftf_for_mujoco.sh [-o OUTPUT.urdf]
...
Options:
  -o  Output URDF path (default: <ros_ws>/src/xela_models/xela_models/mesh/aftf_taxel1_mujoco.urdf)
  -h  Show this help
EOF
}
