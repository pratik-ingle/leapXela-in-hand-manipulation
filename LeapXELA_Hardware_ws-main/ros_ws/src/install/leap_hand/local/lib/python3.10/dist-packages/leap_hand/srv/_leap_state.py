...
class Metaclass_LeapState_Request(type):
    """Metaclass of message 'LeapState_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__leap_state__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__leap_state__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__leap_state__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__leap_state__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__leap_state__request
...
class LeapState_Request(metaclass=Metaclass_LeapState_Request):
    """Message class 'LeapState_Request'."""
...
class Metaclass_LeapState_Response(type):
    """Metaclass of message 'LeapState_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__leap_state__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__leap_state__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__leap_state__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__leap_state__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__leap_state__response
...
class LeapState_Response(metaclass=Metaclass_LeapState_Response):
    """Message class 'LeapState_Response'."""
...
class Metaclass_LeapState(type):
    """Metaclass of service 'LeapState'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'leap_hand.srv.LeapState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__leap_state

            from leap_hand.srv import _leap_state
            if _leap_state.Metaclass_LeapState_Request._TYPE_SUPPORT is None:
                _leap_state.Metaclass_LeapState_Request.__import_type_support__()
            if _leap_state.Metaclass_LeapState_Response._TYPE_SUPPORT is None:
                _leap_state.Metaclass_LeapState_Response.__import_type_support__()


class LeapState(metaclass=Metaclass_LeapState):
    from leap_hand.srv._leap_state import LeapState_Request as Request
    from leap_hand.srv._leap_state import LeapState_Response as Response
